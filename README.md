...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/l8cd99se/settings/api) and create a token with read rights.
...
Join [Slack community](https://www.facebook.com/groups/214452549853531/) or ping us [on Instagram](#).
